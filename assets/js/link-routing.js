(function() {
    var cfg = (window.NOVELLE_SITE_CONFIG && window.NOVELLE_SITE_CONFIG.routing) || {};
    var origin = cfg.origin || "https://dermato-wbs.framer.website";
    var allowed = Array.isArray(cfg.allowed) && cfg.allowed.length ? cfg.allowed : ["https://dermato-wbs.framer.website/"];
    var currentPath = cfg.currentPath || "/";
    var relativeRoot = cfg.relativeRoot || "./";
